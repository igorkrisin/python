...
class Tank:
    def __init__(self, color, px, py, direct, kyeList):
        objects.append(self)
        self.type = 'tank'
        ...
        self.keyLEFT = kyeList[0]
        self.keyRIGHT = kyeList[1]
        self.keyUP = kyeList[2]
        self.keyDOWN = kyeList[3]
        self.keySHOT = kyeList[4]
