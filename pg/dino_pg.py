...
dino_img = [pygame.image.load('Dino2_0.png'), pygame.image.load('Dino2_1.png'), pygame.image.load('Dino2_2.png'),
             pygame.image.load('Dino2_3.png'), pygame.image.load('Dino2_4.png')]
...
def open_random_objects():
    ...
    stone = Object(display_width, display_height - 80, 10, img_of_stone, 3)
